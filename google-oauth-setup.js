...
console.log('='.repeat(80));
console.log();
console.log('STEP 1: Configure Environment Variables');
console.log('- Set GOOGLE_CLIENT_SECRET in your environment/secrets');
console.log('- Set GOOGLE_CLIENT_ID in your environment/secrets');
console.log('- Set GOOGLE_REDIRECT_URI in your environment/secrets');
console.log();
console.log('STEP 2: Add redirect URI to your Google OAuth settings');
...
if (!CLIENT_SECRET || !CLIENT_ID || !REDIRECT_URI) {
  console.log('❌ Please configure GOOGLE_CLIENT_SECRET, GOOGLE_CLIENT_ID, and GOOGLE_REDIRECT_URI environment variables first!');
  process.exit(1);
}
